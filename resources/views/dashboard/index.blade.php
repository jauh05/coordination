...
<div class="flex-grow p-margin max-w-screen-2xl mx-auto w-full space-y-lg">
    ...
    <section class="flex gap-lg overflow-x-auto no-scrollbar pb-xs">
        <button class="flex-shrink-0 flex items-center gap-md bg-white border border-outline-variant/30 px-lg py-md rounded-2xl hover:shadow-md transition-all active:scale-95 group">
            <div class="w-10 h-10 rounded-full bg-secondary-container/30 flex items-center justify-center text-on-secondary-container group-hover:scale-110 transition-transform">
        ...
        <button class="flex-shrink-0 flex items-center gap-md bg-white border border-outline-variant/30 px-lg py-md rounded-2xl hover:shadow-md transition-all active:scale-95 group">
            <div class="w-10 h-10 rounded-full bg-tertiary-container/10 flex items-center justify-center text-tertiary group-hover:scale-110 transition-transform">
