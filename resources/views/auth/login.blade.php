...
<p class="font-body-sm text-body-sm text-black">Sinkronisasi data latensi rendah lintas divisi.</p>
</div>
<div class="glass-panel p-stack-md rounded-xl">
...
<p class="font-body-sm text-body-sm text-black">Enkripsi kunci asimetris end-to-end untuk semua sesi.</p>
</div>
</div>
...
<p class="font-body-sm text-body-sm text-black italic">Saat ini mengawasi sesi Komando Aktif.</p>
</div>
</div>
...
<div class="flex items-center p-1.5 bg-slate-100 dark:bg-slate-800/50 rounded-xl mb-stack-lg relative z-20 shadow-inner">
    ...
    <a href="{{ route('login.ketua') }}" class="flex-1 py-2 text-center rounded-lg font-medium text-sm text-black hover:text-primary hover:bg-slate-200/50 dark:text-slate-400 dark:hover:bg-slate-700/50 transition-all duration-300">Ketua Divisi</a>
    <a href="{{ route('login.anggota') }}" class="flex-1 py-2 text-center rounded-lg font-medium text-sm text-black hover:text-primary hover:bg-slate-200/50 dark:text-slate-400 dark:hover:bg-slate-700/50 transition-all duration-300">Anggota</a>
</div>
...
<input class="w-full h-[48px] pl-12 pr-4 bg-surface-container-lowest border border-outline-variant rounded-lg font-body-md text-body-md text-text-primary placeholder:text-outline/50 input-focus-ring transition-all" id="password" name="password" placeholder="••••••••" type="password" required/>
</div>
@error('password')
<p class="text-xs mt-1" style="color: #ba1a1a;">{{ $message }}</p>
@enderror
...
<label class="font-body-sm text-body-sm text-black" for="remember-me">Ingat saya selama 30 hari</label>
</div>
...
<span class="font-label-sm text-label-sm text-black uppercase">Sistem Beroperasi</span>
</div>
<div class="flex items-center gap-1.5">
<div class="w-2 h-2 rounded-full bg-outline-variant"></div>
<span class="font-label-sm text-label-sm text-black uppercase">Pemindaian Terakhir: 2m lalu</span>
</div>
</div>
</div>
</div>
