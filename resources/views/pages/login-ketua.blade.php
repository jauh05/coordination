...
<div class="flex items-center p-1.5 bg-slate-100 dark:bg-slate-800/50 rounded-xl mb-stack-lg relative z-20 shadow-inner">
    <a href="{{ route('login') }}" class="flex-1 py-2 text-center rounded-lg font-medium text-sm text-black hover:text-primary hover:bg-slate-200/50 dark:text-slate-400 dark:hover:bg-slate-700/50 transition-all duration-300">Event</a>
    <a href="{{ route('login.ketua') }}" class="flex-1 py-2 text-center rounded-lg font-bold text-sm bg-white dark:bg-slate-700 text-primary dark:text-white shadow-[0_2px_8px_-2px_rgba(0,0,0,0.1)] transition-all duration-300">Ketua Divisi</a>
